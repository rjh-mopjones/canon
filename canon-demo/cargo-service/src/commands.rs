// Re-export shared cargo commands. These are defined in canon-demo-shared with
// their #[command] macros which generate Serialize/Deserialize, marker traits,
// and inventory registrations.
pub use canon_demo_shared::commands::{
    BeginUnloading, CloseManifest, CreateManifest, LoadCargo, RecordUnloaded,
};
...
// These are required by #[command_handler] to satisfy compile-time enforcement.
use canon_demo_shared::commands::BeginUnloadingV1HasHandler;
use canon_demo_shared::commands::CloseManifestV1HasHandler;
use canon_demo_shared::commands::CreateManifestV1HasHandler;
use canon_demo_shared::commands::LoadCargoV1HasHandler;
use canon_demo_shared::commands::RecordUnloadedV1HasHandler;
