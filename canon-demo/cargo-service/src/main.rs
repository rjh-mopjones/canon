...
async fn main() -> Result<(), StartupError> {
    ...
    // ── ServiceBuilder ────────────────────────────────────────────────────
    // Uses in-memory impls until canon-core traits are unified with the
    // infrastructure trait crates. Real connections above verify infra
    // readiness and will be swapped in once the trait layer is aligned.
