...
- **Never checkout other branches in the main working directory.** Always use git worktrees for branch work. Checking out branches directly causes dist file conflicts, merge conflicts with agent worktrees, and lost work. The main working directory must always stay on `main`.
