...
| `traits` | `Aggregate`, `CommandHandler`, `CommandStore`, `EventStore`, `SnapshotStore`, `DeadLetterStore`, `RetryTracker`, `Publisher`, `EventHandler`, `EventCombiner`, `InboxPort`, `Projection`, `ProjectionStore`, `ProjectionCheckpointStore`, `ProjectionHandler`, `ProjectionRebuildManager`, `CounterfactualReplay` |
